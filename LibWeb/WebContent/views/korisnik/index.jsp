			...
			<div class="container">
				...
				<div class="row">
					...
					<c:if test="${empty oglasi }">
						Nemate postavljen nijedan oglas.
					</c:if>
					<c:forEach items="${oglasi }" var="oglas"> 
						<div class="col-md-4">
							<div class="post">
								...
								<div class="post-body">
									Pocetna cena: <strong>${oglas.minPonuda }&nbsp;€</strong>
									<div class="post-meta">
				...
				<h3>Vase ponude</h3>
					<c:if test="${empty ponude}">
						Nemate nijednu licitaciju za oglas.
					</c:if>
					<c:forEach items="${ponude }" var="ponuda"> 
						<div class="col-md-4">
							<div class="post">
								<a class="post-img" href="<c:url value="/oglas/detaljiOglasa?id_oglas=${ponuda.ogla.idOgla}"/>"><img src="<c:url value="/oglas/oglasSlika/${ponuda.ogla.idOgla}"/>" height="180" width="130" alt=""></a>
								<div class="post-body">
									Vasa ponuda: <strong>${ponuda.ponudaPare }&nbsp;€</strong>
									<div class="post-meta">
										<a class="post-category cat-1" href="<c:url value="/oglas/detaljiOglasa?id_oglas=${oglas.idOgla}"/>">${ponuda.ogla.naslov }</a>
										<span class="post-date">${ponuda.datumVreme }</span>
									</div>
									<h3 class="post-title">${ponuda.ogla.tekst }</h3>
								</div>
							</div>
						</div>
					</c:forEach>
